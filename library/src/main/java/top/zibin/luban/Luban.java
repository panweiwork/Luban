...
public class Luban implements Handler.Callback {
    ...
    private Luban(Builder builder) {
        ...
        this.mSourceFormat = builder.mSourceFormat;
                    ...
                    public void run() {
                        try {
                            ...
                            File result = Checker.isNeedCompress(mLeastCompressSize, path) ? new Engine(path,
                                    getImageCacheFile(context, Checker.checkSuffix(path)),
                                    Checker.isJPG(path, mSourceFormat)).compress() : new File(path);
    ...
    private File get(String path, Context context) throws IOException {
        return new Engine(path, getImageCacheFile(context, Checker.checkSuffix(path)),
                Checker.isJPG(path, mSourceFormat)).compress();
    }
    ...
    private List<File> get(Context context) throws IOException {
        ...
        while (iterator.hasNext()) {
            ...
            if (Checker.isImage(path) || Checker.getSupportFormat().contains(mSourceFormat)) {
    ...
    public static class Builder {
        ...
        /**
         * set the format of the source file.
         *
         * @param sourceFormat the default support for five formats.   e.g:FormatInterface.JPG、FormatInterface.JPEG
         * @return
         */
